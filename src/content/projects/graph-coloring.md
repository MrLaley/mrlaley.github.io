...
* **Automorphism-Based Pruning:** Implemented pruning techniques to drastically cut down computation times for highly symmetrical graphs. By calculating automorphism groups (using generators, stabilizers, and orbits) and applying the Schreier-Sims membership test, the algorithm counts and identifies symmetries. This knowledge is then used to skip symmetrically equivalent sub-trees during the Branch-and-Bound search, effectively pruning redundant branches and reducing the search space.
